...
class Day9 {
     ...
     * sequence are zeroes, you can extrapolate what the next value of the original history should
     * be.
     *
     ...
     * two numbers from the input. Since these values aren't all zero, repeat the process: the
     * values differ by 0 at each step, so the next sequence is 0 0 0 0. This means you have enough
     ...
     * 114.
     *
     * Analyze your OASIS report and extrapolate the next value for each history. What is the sum
     * of these extrapolated values?
     *
     * Your puzzle answer was 1955513104.
     */
